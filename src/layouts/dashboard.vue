...
<template>
  <div
    class="flex h-screen w-screen flex-col-reverse overflow-hidden lg:flex-row"
  >
    <Sidebar
      class="sticky bottom-0 left-0 z-50 h-20 w-screen bg-white lg:top-0 lg:h-screen lg:w-[18%]"
    />
