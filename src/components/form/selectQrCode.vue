...
<template>
  <div class="relative w-full mb-3 ">
    ...
    <div>
      ...
      <ul v-show="isActive"
        class="h-64 absolute z-20 mt-1 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg  ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
        ...
        <li
          ...
          id="listbox-option-0" role="option" v-for="(item, index) in data" @click="handleOption(item)">
